...
$lang = array_merge($lang, array(
	...
	'DIR_ACTIV_PAGERANK'					=> 'Aktivera pagerank för hemsidorna',
	'DIR_ACTIV_PAGERANK_EXPLAIN'			=> 'Pageranken räknas ut vid det tillfälle som en hemsida läggs till och det är den pageranken som kommer att publiceras.',
	'DIR_ACTIV_REWRITE'						=> 'Aktivera webbadressomskrivning för länklistan ',
	'DIR_ACTIV_REWRITE_EXPLAIN'				=> 'Om du aktiverar detta val så kommer webbadresserna för länklistans kategorier såväl som menyns länk till länklistan att skrivas om efter inställningarna hos tillägget <a href="http://www.phpbb-seo.com/fr/mod-rewrite-phpbb/ultimate-seo-url-t4489.html" target="_blank">Ultimate SEO URL by dcz</a>.<br />En uppdatering av filen .htaccess kommer att behövas.',
	...
	'DIR_REWRITE_PARAM'						=> 'Inställningar för webbadressomskrivning',
